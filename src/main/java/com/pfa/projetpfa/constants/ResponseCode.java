package com.pfa.projetpfa.constants;
...
public class ResponseCode {
	...
	public static final String EMAIL_FOUND = "EMAIL_FOUND_IN_DB";
	public static final String USERNAME_FOUND = "USERNAME_FOUND_IN_DB";
